...
#拷贝终端配置文件
cp ${CONFIG_DIR}/deepin-terminal/config.conf /home/${USER}/.config/deepin/deepin-terminal/

#自定义命令
#cp ${CONFIG_DIR}/deepin-terminal/command-config.conf /home/${USER}/.config/deepin/deepin-terminal/
#远程管理
#cp ${CONFIG_DIR}/deepin-terminal/server-config.conf /home/${USER}/.config/deepin/deepin-terminal/
...
#拷贝系统库
sudo cp ${CONFIG_DIR}/deepin-terminal/libterminalwidget5.so.0.14.1 /lib/x86_64-linux-gnu/libterminalwidget5.so.0.14.1.liwl
sudo ln -fs /lib/x86_64-linux-gnu/libterminalwidget5.so.0.14.1.liwl /lib/x86_64-linux-gnu/libterminalwidget5.so.0.14.1
